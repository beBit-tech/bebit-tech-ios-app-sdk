...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "OmniSegmentKit",
			url: "https://github.com/beBit-tech/bebit-tech-ios-app-sdk/releases/download/1.0.1-beta.0/OmniSegmentKit.xcframework.zip",
			checksum: "6467ee6b9212c32afa9c5c8e5b60aa20b92b77720dfc71fae427a1a76768cebb"
		)
	]
)
