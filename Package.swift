...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "OmniSegmentKit",
			url: "https://github.com/beBit-tech/bebit-tech-ios-app-sdk/releases/download/0.0.4/OmniSegmentKit.xcframework.zip",
			checksum: "b0024625b21283c5c4679060fd078ee974f4ccd1235437629a32717109aa5a13"
		)
	]
)
