...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "OmniSegmentKit",
			url: "https://github.com/beBit-tech/bebit-tech-ios-app-sdk/releases/download/1.0.11-beta.0/OmniSegmentKit.xcframework.zip",
			checksum: "c1aeebb2f421c9894e5ae87234aa08c95be3eea67b30bfd85f22da237976ccc8"
		)
	]
)
