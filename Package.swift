...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "OmniSegmentKit",
			url: "https://github.com/beBit-tech/bebit-tech-ios-app-sdk/releases/download/1.0.3-beta.0/OmniSegmentKit.xcframework.zip",
			checksum: "1eccfee28462567868def44fcdb3a92579253bada794dda3cc03988f90200128"
		)
	]
)
