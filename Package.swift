...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "OmniSegmentKit",
			url: "https://github.com/beBit-tech/bebit-tech-ios-app-sdk/releases/download/1.0.5/OmniSegmentKit.xcframework.zip",
			checksum: "2ace965e62a253f7fac1df300ec685592beb87c332731749cc40d093d67be9e2"
		)
	]
)
