...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "OmniSegmentKit",
			url: "https://github.com/beBit-tech/bebit-tech-ios-app-sdk/releases/download/0.0.5/OmniSegmentKit.xcframework.zip",
			checksum: "489f8ea3ce8bfbfb1a075826ad81e35bf869cbf2fa380a73fe66d680eb922c33"
		)
	]
)
